...
cd /var/www/html/
touch healthstatus
sed -i "s/$db = mysqli_connect('mysql.tooling.svc.cluster.local', 'admin', 'admin', 'tooling');/$db = mysqli_connect('micolo-database.ccztgcogh9jc.us-east-1.rds.amazonaws.com', 'MicoloAdmin', 'passWord.1', 'toolingdb');/g" functions.php
