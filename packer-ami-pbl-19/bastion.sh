...
# Note you can always change the below dat to base64 by typing base64 in google.com, copy and paste the data, then encode it.
# You can paste the encoded information here. You can also decode it.
#!/bin/bash
